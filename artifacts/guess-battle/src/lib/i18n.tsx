...
const dictionaries = {
  en: {
    ...
    "home.gameMode": "Mode",
    "home.mode.ffa": "Free-for-all",
    "home.mode.teams": "2 vs 2 (Teams)",
    ...
    "room.vs": "VS",
    "room.round": "ROUND",
    "room.chooseTarget": "Choose your target",
    "room.chooseTargetDesc": "Pick who you want to guess this turn",
    "room.eliminated": "ELIMINATED",
    "room.waitingRoom": "Waiting for players",
    "room.teamA": "Team A",
    "room.teamB": "Team B",
    "room.opponents": "Opponents",
    "room.yourNumber": "your number",
  },
  ar: {
    "app.title": "جيس باتل",
    ...
    "home.playerCount": "عدد اللاعبين",
    "home.gameMode": "وضع اللعب",
    "home.mode.ffa": "فردي (كل واحد لنفسه)",
    "home.mode.teams": "٢ ضد ٢ (فرق)",
    ...
    "room.vs": "ضد",
    "room.round": "الجولة",
    "room.chooseTarget": "اختار هدفك",
    "room.chooseTargetDesc": "اختار مين عايز تخمن رقمه الدور ده",
    "room.eliminated": "خرج من الجولة",
    "room.waitingRoom": "في انتظار اللاعبين",
    "room.teamA": "فريق أ",
    "room.teamB": "فريق ب",
    "room.opponents": "الخصوم",
    "room.yourNumber": "رقمك",
  },
} as const;
